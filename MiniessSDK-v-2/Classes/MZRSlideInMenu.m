...
//  MZRSlideInMenu
//
//  Created by Contributed By Miniess on 2014/01/21.
...
@interface MZRMenuItem : UIButton
...
- (void)showMenu
{
    ...
    for (int i=0; i < self.menuItems.count; i++)
    {
        ...
        UIFont *labelFont = [UIFont fontWithName:@"HelveticaNeue" size:24.0];
        if (self.font)
        {
            labelFont = self.font;
        }
        ...
        CGRect menuRect = CGRectMake(x, y, menuSize.width + 80, itemBarHeight);
        ...
        //Code by Contributed By Miniess
        menuButton.layer.cornerRadius = 30; // this value vary as per your desire
        ...
        [UIView animateWithDuration:kAnimationDuration delay:delay options:UIViewAnimationOptionCurveEaseOut animations:^
         {
             CGRect newFrame = CGRectMake(newX - 45,
